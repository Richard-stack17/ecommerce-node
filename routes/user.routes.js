...
router.get('/orders', protect ,getOrders); //el protect es para que este protegida, ya que podemos usar de dos maneras la primera es esta y la segunda la de abajo
